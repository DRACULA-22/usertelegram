...
def boten(message):
    ...
    M = types.InlineKeyboardButton('المطور', url='https://t.me/DRACULA_2023')
...
if __name__ == "__main__":
    bot.remove_webhook()
    bot.set_webhook(url="https://usertelegram.herokuapp.com/"+str(BOT_TOKEN))
